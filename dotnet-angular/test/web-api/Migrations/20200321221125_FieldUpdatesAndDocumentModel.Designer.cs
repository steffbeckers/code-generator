...
namespace RJM.API.Migrations
{
    ...
    [Migration("20200321221125_FieldUpdatesAndDocumentModel")]
    partial class FieldUpdatesAndDocumentModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RJM.API.Models.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RJM.API.Models.JobSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RJM.API.Models.JobState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RJM.API.Models.Job", b =>
                {
                    ...
                    b.HasOne("RJM.API.Models.JobState", "JobState")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("RJM.API.Models.JobSkill", b =>
                {
                    ...
                    b.HasOne("RJM.API.Models.Job", "Job")
                        .WithMany("JobSkill")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
