...
namespace Test.API.BLL
{
    ...
    public class ContactBLL
    {
        ...
        public async Task<Contact> UpdateContactAsync(Contact contactUpdate)
        {
            ...
            if (!string.IsNullOrEmpty(contactUpdate.JobTitle))
                contactUpdate.JobTitle = contactUpdate.JobTitle.Trim();
            ...
            if (!string.IsNullOrEmpty(contactUpdate.MobilePhone))
                contactUpdate.MobilePhone = contactUpdate.MobilePhone.Trim();
            if (!string.IsNullOrEmpty(contactUpdate.Gender))
                contactUpdate.Gender = contactUpdate.Gender.Trim();
            ...
            contact.Gender = contactUpdate.Gender;
		...
		/// </summary>
        public async Task<Contact> DeleteContactByIdAsync(Guid contactId)
        {
            Contact contact = await this.contactRepository.GetByIdAsync(contactId);

            return await this.DeleteContactAsync(contact);
        }
