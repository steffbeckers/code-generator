    ...
    public class AccountBLL
    {
        ...
        public async Task<Account> CreateAccountAsync(Account account)
        {
            ...
            if (!string.IsNullOrEmpty(account.Fax))
                account.Fax = account.Fax.Trim();
            if (!string.IsNullOrEmpty(account.Website))
                account.Website = account.Website.Trim();
            if (!string.IsNullOrEmpty(account.VATNumber))
                account.VATNumber = account.VATNumber.Trim();
        ...
        public async Task<Account> UpdateAccountAsync(Account accountUpdate)
        {
            ...
            if (!string.IsNullOrEmpty(accountUpdate.Fax))
                accountUpdate.Fax = accountUpdate.Fax.Trim();
            if (!string.IsNullOrEmpty(accountUpdate.Website))
                accountUpdate.Website = accountUpdate.Website.Trim();
            if (!string.IsNullOrEmpty(accountUpdate.VATNumber))
                accountUpdate.VATNumber = accountUpdate.VATNumber.Trim();
            if (!string.IsNullOrEmpty(accountUpdate.Description))
            ...
            account.Fax = accountUpdate.Fax;
            account.Website = accountUpdate.Website;
            account.VATNumber = accountUpdate.VATNumber;
            account.Description = accountUpdate.Description;
            account.AddressId = accountUpdate.AddressId;
            account.ParentAccountId = accountUpdate.ParentAccountId;
            account.BillingAccountId = accountUpdate.BillingAccountId;
            account.RelationTypeId = accountUpdate.RelationTypeId;
            account.PrimaryContactId = accountUpdate.PrimaryContactId;
