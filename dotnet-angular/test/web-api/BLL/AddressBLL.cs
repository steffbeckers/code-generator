...
namespace Test.API.BLL
{
    ...
    public class AddressBLL
    {
        ...
        public async Task<Address> UpdateAddressAsync(Address addressUpdate)
        {
            ...
            if (!string.IsNullOrEmpty(addressUpdate.State))
                addressUpdate.State = addressUpdate.State.Trim();
            ...
            address.Latitude = addressUpdate.Latitude;
            address.Longitude = addressUpdate.Longitude;
            address.CountryId = addressUpdate.CountryId;
        ...
        {
            Address address = await this.addressRepository.GetByIdAsync(addressId);

            return await this.DeleteAddressAsync(address);
        }
