...
function service(options) {
    return (host, context) => {
        ...
        const rule = schematics_1.chain([options.skipVo ? schematics_1.noop() : schematics_1.schematic(constants_1.constants.voSchematic, voOptions), schematics_1.mergeWith(templateSource, schematics_1.MergeStrategy.Default)]);
