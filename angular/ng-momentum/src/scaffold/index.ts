...
import { addScriptIntoPackageJson, addValueIntoAngularJsonBuildProjects, readValueFromAngularJsonBuildProjects } from '../utils/json-editor';
  ...
  return (host: Tree) => {
    [
      ...
      },
      {
        key: 'compile',
        value:
          'for lang in en; do ng build --output-path=dist/$lang --prod --base-href=/$lang/ --i18n-file=src/locale/messages.$lang.xlf --i18n-format=xlf --i18n-locale=$lang; done',
      },
      {
        key: 'docs',
