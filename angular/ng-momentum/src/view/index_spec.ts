...
describe('view', () => {
  ...
  describe('with project', () => {
    ...
    it('blank works', () => {
      ...
      expect(
        tree
          .readContent('/projects/bar/src/app/app.routing.module.ts')
          .indexOf("{'path': 'test', 'loadChildren': '../app/views/test/test.module#TestModule'},")
  ...
  describe('with eager loading', () => {
    ...
    it('blank works', () => {
      ...
      expect(
        tree.readContent('/projects/bar/src/app/core/core.module.ts').indexOf("import { TestModule } from '../test/test.module';")
      ).toBeGreaterThanOrEqual(0);
