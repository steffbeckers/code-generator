...
namespace CodeGenOutput.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CodeGenOutputDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CodeGenOutputEfCoreEntityExtensionMappings to extend the IdentityUser entity
